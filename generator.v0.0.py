...
class AlienCeramicsGenerator:
    def __init__(self, colors: List[str]):
        ...
        self.base_descriptions = [
            "Ethereal alien ceramic vessel photographed in a museum setting",
            "Extraterrestrial pottery artifact on museum display",
            "Otherworldly ceramic sculpture in a curated exhibition space",
            "Cosmic clay formation in a gallery environment",
            "Interstellar ceramic art piece on museum pedestal"
        ]
